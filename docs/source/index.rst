...
`Issues, bugs and new features <https://github.com/dpgaspar/DT-Config-Manager/issues/new>`_

`Contribute <https://github.com/dpgaspar/DT-Config-Manager/fork>`_
